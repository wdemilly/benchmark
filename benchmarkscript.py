...
# Optional providers. The app should fail clearly if the selected provider is unavailable.
try:
...
def decode_packet_bytes(packet_bytes: Optional[bytes]) -> str:
    ...
    try:
        ...
        try:
            return packet_bytes.decode("latin-1")
    ...
    with left:
        ...
        if packet_mode == "upload_file":
            ...
            if uploaded is not None:
                ...
                packet_text = decode_packet_bytes(packet_bytes)
